...
#ifndef IDOL_PL_PARSER_PLA_H
#define IDOL_PL_PARSER_PLA_H
...
gboolean idol_pl_parser_save_pla				(IdolPlParser *parser,
                                                                 IdolPlPlaylist *playlist,
								 GFile *output,
								 const char *title,
								 GError **error);

IdolPlParserResult idol_pl_parser_add_pla			(IdolPlParser *parser,
								 GFile *file,
								 GFile *base_file,
