...
#ifndef IDOL_PL_PARSER_XSPF_H
#define IDOL_PL_PARSER_XSPF_H
...
gboolean idol_pl_parser_save_xspf (IdolPlParser *parser,
...
IdolPlParserResult idol_pl_parser_add_xspf (IdolPlParser *parser,
					      GFile *file,
					      GFile *base_file,
